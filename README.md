...
```bash
pip install git+https://github.com/Sam-Strand/date_hour_py.git
```

### Способ 2: Установка готового пакета (без Git)
```bash
pip install https://github.com/Sam-Strand/date_hour_py/releases/download/v1.0.0/date_hour_py-1.0.0-py3-none-any.whl
```
